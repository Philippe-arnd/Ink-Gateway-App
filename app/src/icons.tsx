// Small inline SVG icons (currentColor stroke) instead of emoji — emoji
// glyphs depend on a color-emoji font being installed, which isn't a safe
// assumption across every deployment/OS; these always render.
